...
const API={
  ...
  async _q(p,o={}){try{const r=await fetch(SUPA.URL+'/rest/v1/'+p,{headers:this._h(),...o});if(!r.ok)return null;const t=await r.text();return t?JSON.parse(t):[];}catch(e){return null;}},
